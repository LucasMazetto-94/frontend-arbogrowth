...
const CheckoutButton = ({ total, onStatusCompra, nomeCliente, shippingId }) => {
  ...
  useEffect(() => {
    const initializeCardForm = async () => {
      ...
      const mp = new window.MercadoPago(
        ...
        "APP_USR-73e406e8-7bc4-4e58-89cc-5d24f4309673"
      );
        ...
        callbacks: {
          ...
          onSubmit: async (event) => {
            ...
            try {
              ...
              localStorage.setItem("shippingStorage", shippingId);
            } catch (error) {
